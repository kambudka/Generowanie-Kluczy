...
namespace Generowanie_Kluczy
{
    class Program
    {
        ...
        public void ReadKey(string name)
        {
            ...
            byte readbyte;
            int bit = 0;
            string path = @"C:\Users\Zalgo\Desktop\Testy\Pusty";
        ...
        public void Encode(string name)
        {
            ...
            byte nul = 0;
            byte extra = 0;
            bool[] indextest = new bool[8] { true, false, true, false, false, false, true, false };
            BitArray testowe = new BitArray(indextest);
            BitArray testowe2 = new BitArray(new byte[] { 11 });
            ...
            while (br.BaseStream.Position != br.BaseStream.Length)
            {
                ...
                for (int j = 0; j < 64; j++)
                {
                    ...
                    //Console.Write(FileBlock.Get(IP[j] - 1));
        ...
        public void Decode(string name)
        {
            ...
            BinaryWriter bw;
            byte readbyte;
            string path = @"C:\Users\Zalgo\Desktop\Testy\testencoded.bin";
            ...
            try { bw = new BinaryWriter(new FileStream(@"C:\Users\Zalgo\Desktop\Testy\testdecoded.bin", FileMode.Create)); }
            catch (IOException e)
            {
                Console.WriteLine(e.Message + "\n Cannot create file.");
                return;
